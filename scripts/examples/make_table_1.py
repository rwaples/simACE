...
Example::
    ...
    python scripts/examples/make_table_1.py --summary results/{folder}/report_summary.tsv --out_dir paper
"""
...
def write_table_1(summary_tsv: str, out_dir: str = "paper", word: bool = False) -> None:
...
def main(argv: list[str] | None = None) -> None:
    """Parse flags and write table_1.csv (and optionally table_1.docx)."""
    ...
    write_table_1(args.summary, args.out_dir, word=args.word)
