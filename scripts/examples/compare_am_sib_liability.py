r"""Sib-pair liability scatter across AM levels.

Example (``--min-generation`` is ``max(1, G_pheno // 2)`` of the first scenario)::

    python scripts/examples/compare_am_sib_liability.py \
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--output", default="docs/images/examples/am/sib_liability_scatter.png")
    ...
    setup_logging(log_file=args.log, tag="examples/am_sib_liability")
