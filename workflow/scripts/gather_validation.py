...
def extract_metrics(validation_path, scenario):
    ...
    row = {
        ...
        'half_sib_A_corr': get_nested(data, 'half_sibs', 'half_sib_A_correlation', 'observed'),
        'half_sib_pheno_corr': get_nested(data, 'half_sibs', 'half_sib_phenotype_correlation', 'observed'),
        'half_sib_shared_C': get_nested(data, 'half_sibs', 'half_sib_shared_C', 'observed'),
