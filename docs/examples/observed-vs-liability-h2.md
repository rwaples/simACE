...
- **Under LTM**, liability-Falconer and tetrachoric-Falconer coincide
  and both land within sampling noise of realized $h^2$. This
...
- **Under cure-frailty**, tetrachoric *also* recovers realized $h^2$,
  ...
  magnitude. The cure fraction is a hard susceptibility cutoff, and acts as
...
indicator is itself a threshold-like variable). For smooth
...
first-passage-time) is a necessary correction.
